  ...
  return (
    <>
      ...
      <PageBanner
        ...
        shortText="Your trust matters to us. At MediBridge, we are committed to protecting your personal information and ensuring your data is kept safe, secure, and confidential."
        homePageUrl="/"
        homePageText="Home"
      ...
      <div className="privacy-policy-area ptb-140">
        <div className="container">
          <div className="privacy-policy-content">
            <p>
              <i>This Privacy Policy was last updated on December 09, 2025.</i>
            </p>
            <h3>
...
export default withLayoutBasic(PrivacyPolicy);
