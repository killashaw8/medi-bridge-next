  ...
  return (
    <>
      ...
      <PageBanner
        ...
        shortText="By using MediBridge services, you agree to our terms and conditions. Please review them carefully to understand your rights, responsibilities, and our commitment to providing safe and reliable healthcare."
        homePageUrl="/"
        homePageText="Home"
      ...
      <div className="terms-of-service-area ptb-140">
        <div className="container">
          <div className="terms-of-service-content">
            <p>
              <i>
                This Terms of Service was last updated on December 19, 2025.
              </i>
            </p>
            <h3>
            ...
            <blockquote className="blockquote">
              <p>
                ...
                data from third-party platforms you connect with MediBridge. We also
